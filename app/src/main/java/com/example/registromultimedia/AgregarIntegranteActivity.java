...
public class AgregarIntegranteActivity extends BaseDrawerActivity {

    EditText etNombre, etComentarios;
      Spinner spRol, spNivel;
    ...
    @Override
      protected int idPropio() {
                return R.id.menu_agregar_integrante;
      }
    ...
    private void agregarIntegrante() {
          ...
          IntegranteRepository.lista.add(new Integrante(nombre, rol, tecnologias.toString(), genero, valoracion));
